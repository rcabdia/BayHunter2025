...
def gochain2(chainidx, chains, chainlist):
...
class MCMC_Optimizer(object):
    ...
    def mp_inversion(self, baywatch=False, dtsend=0.5, nthreads=0):
        ...
        while True:
            ...
            p = mp.Process(name='chain %d' % chainidx, target=gochain2,
                           kwargs={'chainidx': chainidx,'chains':self.chains, 'chainlist':self.chainlist})
