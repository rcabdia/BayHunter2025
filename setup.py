...
# ---- Cython/C++ extension (only cythonize this one) ----
rfmini_ext = Extension(
    "BayHunter.rfmini",
    sources=[
        "src/BayHunter/extensions/rfmini/rfmini.pyx",
        "src/BayHunter/extensions/rfmini/greens.cpp",
        "src/BayHunter/extensions/rfmini/model.cpp",
        "src/BayHunter/extensions/rfmini/pd.cpp",
        "src/BayHunter/extensions/rfmini/synrf.cpp",
        "src/BayHunter/extensions/rfmini/wrap.cpp",
        "src/BayHunter/extensions/rfmini/fork.cpp",
    ],
...
setup(
    ...
    scripts=["src/BayHunter/scripts/baywatch"],
